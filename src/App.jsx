  ...
  return (
    <div className='p-16 w-full h-screen   '>
      ...
      <div className='flex gap-10 flex-wrap'>
        ...
        <div className='mt-20 flex-1 md:p-0 '>
          ...
          <div className='flex gap-4 p-1 border border-white  rounded-xl hover:shadow-md hover:border-base-300  transition duration-300'>
            ...
            <div className='mt-2 text-wrap '>
              <p className='text-xl flex items-center gap-2'>tasqie <span className='bg-base-200 px-1 text-[11px] rounded-md text-nowrap '>Coming soon </span> </p>
